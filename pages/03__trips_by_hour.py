...
def run_query_data1():
    ...
    query = "SELECT timestamp_start AS date_time, latitud_start AS lat, longitud_start AS lon FROM `vacio-276411.mainDataset.trips_a` WHERE DATE(timestamp_start) = '2021-05-14'"
...
#Midpoint as la_guardia becouse midpoint is not working
midpoint = la_guardia
